...
import { Users, HelpCircle, FileText, Calendar } from 'lucide-react'
  ...
  return (
    <div className="px-4 lg:px-6">
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <p className="text-muted-foreground">Academic Staff dashboard for managing student records, academic support, documentation, and appointments.</p>
        </CardContent>
      </Card>
    </div>
  )
