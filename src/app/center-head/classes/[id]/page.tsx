...
import { CHClassDetailHeader } from './components/CHClassDetailHeader'
import { AAClassDetailHeaderSkeleton, AAClassDetailContentSkeleton } from '@/app/academic/classes/[id]/components/AAClassDetailSkeleton'
import { OverviewTab } from '@/app/academic/classes/[id]/components/OverviewTab'
import { StudentsTab } from '@/app/academic/classes/[id]/components/StudentsTab'
import { SessionsTab } from '@/app/academic/classes/[id]/components/SessionsTab'
import { StudentDetailDrawer } from '@/app/academic/students/components/StudentDetailDrawer'

export default function CenterHeadClassDetailPage() {
    ...
    return (
        ...
        >
            ...
            {/* Student Detail Drawer (read-only for Center Head) */}
            <StudentDetailDrawer
