...
const TeacherClassDetailPage = () => {
              ...
              apiData.teachers.length > 0
                ? apiData.teachers.map((t, index) => ({
                    ...
                    isPrimaryInstructor:
                      ...
                      t.sessionCount ===
                        Math.max(
                          ...apiData.teachers.map((tt) => tt.sessionCount)
            ...
            nextSession: apiData.upcomingSessions?.[0]
              ? {
                  ...
                  type: apiData.upcomingSessions[0].type as
                    | "CLASS"
                    | "TEACHER_RESCHEDULE",
                  status: apiData.upcomingSessions[0].status as
                    | "PLANNED"
                    | "CANCELLED"
                    | "DONE",
  ...
  const renderHeader = () => {
    ...
    return <ClassHeader classDetail={classDetail} />;
  };
                ...
                <div className="max-w-7xl mx-auto space-y-6 px-4 py-6 sm:px-6 lg:px-8 md:py-8">
                  ...
                  {!isDetailLoading && detailError && (
                    <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-destructive/40 bg-destructive/10 p-8 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Vui lòng thử lại hoặc quay lại danh sách lớp.
                      </p>
