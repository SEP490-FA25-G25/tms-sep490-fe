...
export default function TeacherProfilePage() {
  ...
  const currentClasses = useMemo(() =>
    profile?.classes.filter(c => c.status === 'ONGOING' || c.status === 'ACTIVE') || [],
    [profile]
  );

  const completedClasses = useMemo(() =>
    profile?.classes.filter(c => c.status === 'COMPLETED' || c.status === 'ENDED') || [],
    [profile]
  );
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              <div className="space-y-3">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <Badge variant="secondary">{profile.teacherCode}</Badge>
                </div>
          ...
          <div className="rounded-lg border bg-muted/10 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <p className="text-base text-foreground">{profile.teacherCode}</p>
              </div>
              <div className="space-y-1">
                <div className="flex items-center gap-2 text-sm font-medium text-muted-foreground">
                  <User className="h-4 w-4" />
              ...
              {profile.phone && (
                <div className="space-y-1">
                  ...
                  <p className="text-base text-foreground">{profile.phone}</p>
                </div>
              )}
              {profile.gender && (
                <div className="space-y-1">
              ...
              {profile.address && (
                <div className="space-y-1 md:col-span-2">
                  ...
                  <p className="text-base text-foreground">{profile.address}</p>
                </div>
              )}
              {profile.facebookUrl && (
                <div className="space-y-1 md:col-span-2">
              ...
              {profile.branchName && (
                <div className="space-y-1">
                  ...
                  <p className="text-base text-foreground">{profile.branchName}</p>
                </div>
              )}
            </div>
          </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
                      ...
                      <TableHead className="w-32 text-center">Ngày phân công</TableHead>
                      <TableHead className="w-48 text-center">Thời gian dạy</TableHead>
                    ...
                    {currentClasses.map((cls) => (
                      ...
                      >
                        ...
                        <TableCell className="text-sm text-center">
                          {new Date(cls.assignedAt).toLocaleDateString('vi-VN')}
                        </TableCell>
                        <TableCell className="text-sm text-center">
