...
import { useUpdateUserMutation, type UpdateUserRequest, type UserResponse } from '@/store/services/userApi'
...
export function EditUserDialog({ open, onOpenChange, user, onUpdateSuccess }: EditUserDialogProps) {
