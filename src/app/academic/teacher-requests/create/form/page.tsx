...
export default function CreateRequestFormPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigate(`/academic/teacher-requests`);
    } catch (error: unknown) {
  ...
  const handleBack = () => {
    navigate(
      `/academic/teacher-requests/create/select-session?teacherId=${teacherId}&type=${requestType}`
    );
  };
  ...
  return (
    <DashboardLayout
      ...
      description="Điền thông tin yêu cầu"
    >
