...
export function AAClassDetailHeader({
  ...
  // Cho phép chỉnh sửa nếu là DRAFT hoặc bị REJECTED
  const isEditable = classData.status === 'DRAFT' || classData.approvalStatus === 'REJECTED'
        ...
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2 shrink-0">
              {/* Nút Chỉnh sửa - chỉ hiển thị với DRAFT hoặc REJECTED */}
              {isEditable && (
                <Button
                  variant="outline"
                  onClick={() => navigate(`/academic/classes/${classData.id}/edit`)}
                >
